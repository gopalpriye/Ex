...
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002489642006"))
...
# ----------------D--------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7527954976:AAG18eVvsB3BezEzo4e3UYeiYmSRzL-Osfk")
# -----------------A-------------------------------
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5637668210").split()))
# ------------------------------------------------
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002489642006"))
# ------------------------------------------------
